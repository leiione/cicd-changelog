            ...
            {isEditing ? (
                <>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '10px' }}>
                        <Button color="primary" variant="outlined" onClick={handleSave} style={{ marginRight: '10px' }}>
                            Save
                        </Button>
                        <Button variant="outlined" color="default" onClick={handleCancel} style={{ marginRight: '10px' }}>
                            Cancel
                        </Button>
                ...
                <Paper
                    elevation={3}
                    style={{ padding: '16px', marginTop: '16px', cursor: 'pointer' }}
